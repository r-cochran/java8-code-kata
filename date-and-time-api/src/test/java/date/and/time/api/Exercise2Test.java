...
public class Exercise2Test {
    ...
    public void localTimeWith() {
         ...
         */
        LocalTime localTime = LocalTime.from(lt).withHour(21);
    ...
    public void localTimePlus() {
         ...
         */
        LocalTime localTime = LocalTime.from(lt).plusMinutes(30);
    ...
    public void localTimeMinus() {
         ...
         */
        LocalTime localTime = LocalTime.from(lt).minusHours(3);
    ...
    public void localTimeMinusDuration() {
        ...
        LocalTime localTime = LocalTime.from(lt).minus(duration);
    ...
    public void localDateIsBefore() {
         ...
         */
        boolean isBefore2307 = LocalTime.from(lt).isAfter(lt2);
    ...
    public void localTimeTruncatedTo() {
         ...
         */
        LocalTime localTime = LocalTime.from(lt).truncatedTo(ChronoUnit.MINUTES);
