...
public class Exercise4Test {
    ...
    public void zonedDateTimeFormat() {
         ...
         */
        String strZdt = zdt.format(DateTimeFormatter.ofPattern("yyyy_MM_dd_H_mm_ss_z"));
    ...
    public void sameInstantAs() {
         ...
         */
        ZonedDateTime zonedDateTime = ZonedDateTime.from(zdt).withZoneSameInstant(ZoneId.of("America/Los_Angeles"));
    ...
    public void sameLocalAs() {
         ...
         */
        ZonedDateTime zonedDateTime = ZonedDateTime.from(zdt).withZoneSameLocal(ZoneId.of("America/Los_Angeles"));
