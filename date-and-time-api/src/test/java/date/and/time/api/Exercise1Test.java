...
public class Exercise1Test {
    ...
    public void localDateWith() {
         ...
         */
        LocalDate localDate = LocalDate.from(ld).withYear(2015);
    ...
    public void localDateWithAdjuster() {
         ...
         */
        LocalDate localDate = LocalDate.from(ld).with(TemporalAdjusters.firstDayOfNextYear());
    ...
    public void localDatePlus() {
         ...
         */
        LocalDate localDate = LocalDate.from(ld).plusMonths(10);
    ...
    public void localDateMinus() {
         ...
         */
        LocalDate localDate = LocalDate.from(ld).minusDays(10);
    ...
    public void localDatePlusPeriod() {
        ...
        LocalDate localDate = LocalDate.from(ld).plus(period);
    ...
    public void localDateIsAfter() {
         ...
         */
        boolean isAfter0618 = LocalDate.from(ld2).isAfter(ld);
